...
public class Main {
    ...
    // main homework (result)
        System.out.println(ageAndTemp(10));
        System.out.println(ageAndTemp(27));
        System.out.println(ageAndTemp(-10));
        System.out.println(ageAndTemp(15));
        System.out.println(ageAndTemp(-20));
    ...
    // main task (algorithm)
    public static String ageAndTemp( int temp) {
